    ...
    public static InferenceProjectDocument FromLoadable(IJsonLoadableState loadableModel)
    {
        return new InferenceProjectDocument
        {
            ProjectType = loadableModel switch
            {
                ...
                InferenceMiniMaxH3TextToImageViewModel => InferenceProjectType.MiniMaxH3TextToImage,
                InferenceMiniMaxH3ImageToVideoViewModel => InferenceProjectType.MiniMaxH3ImageToVideo,
                InferenceMiniMaxH3VideoToVideoViewModel => InferenceProjectType.MiniMaxH3VideoToVideo,
                InferenceMiniMaxH3TextToVideoViewModel => InferenceProjectType.MiniMaxH3TextToVideo,
                ...
                InferenceLtxvKeyframeInterpViewModel => InferenceProjectType.LtxvKeyframeInterp,
                InferenceLtxvVideoRetakeViewModel => InferenceProjectType.LtxvVideoRetake,
                InferenceLtxvLipDubViewModel => InferenceProjectType.LtxvLipDub,
                InferenceLtxvHdrIcLoraViewModel => InferenceProjectType.LtxvHdrIcLora,
